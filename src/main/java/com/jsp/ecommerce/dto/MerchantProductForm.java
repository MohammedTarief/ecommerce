...
/**
 * Form backing bean for merchant add/edit product screens. Renamed from ProductDto so a fresh
 * {@code .class} is produced (avoids stale bytecode missing Lombok-generated accessors).
 */
public class MerchantProductForm {
