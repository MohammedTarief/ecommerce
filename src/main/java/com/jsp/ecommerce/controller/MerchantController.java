...
public class MerchantController {
	...
	public String loadAddProduct(@ModelAttribute("productDto") MerchantProductForm productDto, Model model,
			HttpSession session) {
		return merchantService.loadAddProduct(productDto, model, session);
	}

	@PostMapping("/add-product")
	public String addProduct(@Valid @ModelAttribute("productDto") MerchantProductForm productDto,
			BindingResult result, HttpSession session, Model model) {
		return merchantService.addProduct(productDto, result, session, model);
	}
	...
	public String updateProduct(@Valid @ModelAttribute("productDto") MerchantProductForm productDto,
			BindingResult result, Model model, @RequestParam("id") Long id, HttpSession session) {
